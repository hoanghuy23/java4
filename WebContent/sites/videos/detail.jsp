				...
				<div class="card-footer-btn">
					<c:choose>
						<c:when test="${favorite != null }">
							<button
								formaction="DetailVideoServlet/delete?videoId=${video.videoId }"
								class="btn-unlike">Unlike</button>
						</c:when>
						<c:otherwise>
							<button
								formaction="DetailVideoServlet/insert?videoId=${video.videoId }"
								class="btn-like">Like
							</button>
						</c:otherwise>
					</c:choose>
					<button
						formaction="DetailVideoServlet/share?videoId=${video.videoId }"
